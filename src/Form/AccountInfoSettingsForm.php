...
//    drupal_add_js(array('smartling' => array('checkAllId' => array('#edit-target-locales'))), 'setting');
    ...
    $form['account_info']['api_url'] = [
      ...
      '#maxlength' => 255,
      '#required' => FALSE,
      '#description' => t('Set api url. Default: @api_url', ['@api_url' => $this->config('smartling.account_info')->get('smartling_api_url')]),
    ];
    ...
    $form['account_info']['smartling_key'] = [
      '#type' => 'textfield',
      '#title' => t('Key'),
      '#default_value' => '',
      '#description' => t('Current key: @key', ['@key' => $this->hideKey($this->config('smartling.account_info')->get('project_id'))]),
      '#size' => 40,
      '#maxlength' => 40,
      '#required' => FALSE,
    ];
...
//    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('smartling.account_info')
      ...
      ->set('smartling_key', $form_state->getValue('smartling_key'))
